...
const KNT_CLIENT_VERSION="3.3.0";
...
const legalCopy={
 ...
 about:`<h3>Kaali Ni Tidi Ultimate</h3><p>Version 3.3 combines 3–8 player custom rules, secure server-authoritative play, live voice, ranked seasons, tournaments, replays, series, achievements, missions and fair-play receipts.</p>`};
